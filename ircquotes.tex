...
\begin{document}
\maketitle{}
\thispagestyle{empty}      % no pagenumbering
\cleardoublepage{}		   % empty page before preface

\pagestyle{headings}	   % print headings on each page	
\setcounter{page}{1}       % this page is first page
\pagenumbering{roman}      % page numbers in roman numerals

\subsection*{Preface}      % do not number this heading
\addcontentsline{toc}{subsection}{Preface} % include in toc
...
\cleardoublepage{} % begin from uneven page
...
\input{ubuntu}	% include the file ubuntu.tex
\cleardoublepage{} % begin from uneven page

\input{ubuntu-ops}
% \cleardoublepage{} % begin from uneven page, remove comment when
% the kubuntu.tex actually contains something

\input{kubuntu}
% \cleardoublepage{} % begin from uneven page, remove comment when
% the ubuntu-offtopic.tex actually contains something

\input{ubuntu-offtopic}
\end{document}
